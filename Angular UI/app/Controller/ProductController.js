main.controller('ProductController', ['$scope', function($scope){
...
main.directive('mdTable', function () {
  return {
    restrict: 'E',
    scope: { 
      headers: '=', 
...
/*
main.directive('mdColresize', function ($timeout) {
  return {
    restrict: 'A',
...
main.directive('showFocus', function($timeout) {
